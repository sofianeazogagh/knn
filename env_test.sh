...
# Example runs:
# Running with dataset 'cancer', k values [3,5], model size 10, test size 1, and 10 repetitions
# Running with dataset 'cancer', k values [3,5], model sizes [10,40,50], test size 1, and 10 repetitions


cargo run --release -- cancer 3,5 10 1 10